    ...
    <div className="page">
      <div className="page-header">
        ...
        <p className="page-subtitle" style={{ marginTop: '0.5rem' }}>
          Dashboard showing the most and least active users based on events, portfolio, and activity.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="stats-grid" style={{ marginBottom: '2rem' }}>
          ...
          <div className="stat-card">
            <span className="stat-icon" style={{ color: 'var(--admin-accent)', background: 'rgba(204,17,17,0.1)' }}>
          ...
          <div className="stat-card">
            <span className="stat-icon" style={{ color: '#888', background: 'rgba(255,255,255,0.05)' }}>
              <AdminIcon name="Users" size={28} aria-hidden="true" />
            </span>
            <div>
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p className="page-subtitle" style={{ marginTop: '0.25rem', fontSize: '0.8rem' }}>
            <strong>Scoring Logic:</strong> 40% active days (30d), 30% events attended, 30% portfolio completion.<br/>
            <strong>Inactive Logic:</strong> Less than 2 active days in the last 30 days and 0 events attended.
          </p>
        </div>
                  ...
                  <tr key={user.id}>
                    ...
                    <td>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <div style={{ flex: 1, background: 'rgba(255,255,255,0.1)', height: '6px', borderRadius: '3px', overflow: 'hidden' }}>
                          <div style={{ width: `${user.portfolioCompletion}%`, background: 'var(--admin-accent)', height: '100%' }} />
                        </div>
                    ...
                    <td>
                      <span style={{ 
                        ...
                        fontSize: '0.8rem',
                        fontWeight: 600,
                        backgroundColor: user.engagementScore >= 80 ? 'rgba(34, 197, 94, 0.15)' : 
                                         user.engagementScore >= 40 ? 'rgba(234, 179, 8, 0.15)' : 'rgba(239, 68, 68, 0.15)',
                        color: user.engagementScore >= 80 ? '#4ade80' : 
                               user.engagementScore >= 40 ? '#facc15' : '#f87171'
                      }}>
                    ...
                    <td>
                      <span style={{
                        color: user.status === 'Active' ? 'var(--admin-text)' : 'var(--admin-text-muted)',
