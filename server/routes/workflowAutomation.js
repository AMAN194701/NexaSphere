...
router.put('/requests/:id/reject', controller.rejectRequest);

router.post('/requests/bulk-approve', controller.bulkApprove);
...
// Escalation
router.post('/escalate', controller.escalatePendingRequests);
