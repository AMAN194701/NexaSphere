...
const ICON_MAP = {
  ...
  AlertTriangle, PartyPopper, ArrowUp, Pin, Link, MessageCircle, Sparkles,
  GraduationCap, GitBranch, Copy, Trophy, Cloud, Smartphone,
  Megaphone, Palette, Puzzle, PenLine, Handshake, BookOpen,
  Sprout, Award, Search, FileText, UserRound, ShieldCheck,
  // Fallbacks
  Linkedin: Briefcase,
  Github: Code2,
  Instagram: Camera,
...
export function DynamicIcon({ name, size = 16, className = '', ...props }) {
  const IconComponent = ICON_MAP[ICON_ALIASES[name] || name];
